  ...
  const tiers = [
    {
      ...
      filter: (p: Project) => p.priceRange.min < 9900000,
    ...
    },
    {
      ...
      filter: (p: Project) => p.priceRange.min >= 10000000 && p.priceRange.max <= 20000000,
    ...
    },
    {
      ...
      filter: (p: Project) => p.priceRange.min > 20000000,
